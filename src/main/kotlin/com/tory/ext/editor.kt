package com.tory.ext

import com.tory.DartFileNotWellFormattedException
import com.tory.ext.psi.allChildren
import com.tory.ext.psi.body
import com.tory.ext.psi.findChildrenByType
import com.tory.ext.psi.mySiblings
...
fun Editor.evalAnchorInClass(dartClass: DartClass): PsiElement {
    ...
    val body = dartClass.body ?: throw com.tory.DartFileNotWellFormattedException("No Class body found for the dart class")
