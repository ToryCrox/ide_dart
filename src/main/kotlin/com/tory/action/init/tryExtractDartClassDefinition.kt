package com.tory.action.init

import com.tory.constants.Constants
import com.tory.ext.psi.findParentClassDefinition
    ...
    if (currentReference == null) {
        if (feedbackOnError) {
            Notifications.Bus.notify(
                Notification(
                    com.tory.constants.Constants.NOTIFICATION_ID,
                    "No reference found",
